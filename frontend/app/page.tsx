    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20">
      ...
      <main className="container-mobile md:container-tablet lg:container-desktop py-8">
        ...
        <section className="mb-12" aria-labelledby="quick-actions-title">
          <h2 id="quick-actions-title" className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6 text-center">
            🚀 Ações Rápidas
          </h2>
          <QuickActions />
        </section>
        ...
        <section aria-labelledby="modules-title">
          <h2 id="modules-title" className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-8 text-center">
            💜 Seus Módulos de Empoderamento
          </h2>
          ...
          <div className="grid-responsive">
            ...
            <ComplianceCard
              ...
              features={[
                "Detector de habilidades com IA",
                "Ajuste automático de currículo",
                "Simulador de entrevistas",
                "Vagas compatíveis com horário escolar"
              ]}
            />
            ...
            <ComplianceCard
              ...
              features={[
                "Gamificação: 'Conquiste o CadÚnico'",
                "Sistema de badges",
                "Recompensas reais",
        ...
        <section className="mt-16 py-12 bg-white dark:bg-gray-800 rounded-2xl shadow-soft" aria-labelledby="impact-title">
          <h2 id="impact-title" className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-8 text-center">
        ...
        <section className="mt-16" aria-labelledby="testimonials-title">
          <h2 id="testimonials-title" className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-8 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="card">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                "O Mãe Conecta me ajudou a conseguir o BPC do meu filho em apenas 3 meses. 
                A Clara me guiou em cada passo e eu não me senti sozinha."
              </p>
            ...
            <div className="card">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                "Encontrei um trabalho home office perfeito através do Conecta-Vagas. 
                Agora posso cuidar da minha filha e ter minha independência financeira."
              </p>
              <div className="flex items-center">
